...
function idEquals(id1, id2) {
  ...
  if ((typeof id1 === 'number' && typeof id2 === 'string') ||
	...
	if (Array.isArray(JSON.parse(JSON.stringify(id1)))) {
      console.log("first was array");
		if (JSON.parse(JSON.stringify(id1)).indexOf(JSON.parse(JSON.stringify(id2))) > -1) return true;
	}
	if (Array.isArray(JSON.parse(JSON.stringify(id2)))) {
     console.log("second was array");
		if (JSON.parse(JSON.stringify(id2)).indexOf(JSON.parse(JSON.stringify(id1))) > -1) return true;
	}
  
  console.log(`first: ${JSON.stringify(JSON.parse(JSON.stringify(id1)))}`);
  console.log(`second: ${JSON.stringify(JSON.parse(JSON.stringify(id2)))}`);
